export default async function handler(req, res) {
  const staticUrls = [
    ...
    { loc: 'https://roznamaads.pk/blog.html', freq: 'weekly', priority: '0.6' },
    { loc: 'https://roznamaads.pk/blog/newspaper-ads-online-pakistan.html', freq: 'monthly', priority: '0.5' },
    { loc: 'https://roznamaads.pk/blog/property-ads-newspaper-guide.html', freq: 'monthly', priority: '0.5' },
    { loc: 'https://roznamaads.pk/blog/government-job-ads-pakistan-guide.html', freq: 'monthly', priority: '0.5' },
    { loc: 'https://roznamaads.pk/blog/purani-gari-ads-newspaper-guide.html', freq: 'monthly', priority: '0.5' },
    { loc: 'https://roznamaads.pk/blog/rishta-ads-newspaper-guide.html', freq: 'monthly', priority: '0.5' },
